    ...
    def against_cmd(
        ...
        suite: str = typer.Option(
            ...
            help=(
                ...
                "(exit 2). cwd-contained. The generated pre-push hook passes "
        ...
        ``0`` when no regression is detected, ``1`` for a regression,
        ``2`` for invalid input, and ``3`` when comparison data is unavailable.
        Designed to be invoked from the pre-push hook generated by
