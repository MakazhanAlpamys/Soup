...
- **New Training** — create configs from templates or 145 ready-made recipes, validate, start training with live SSE log streaming and progress bar
...
- **Config Builder** — recipe dropdown (145 recipes), config schema API for dynamic form generation
