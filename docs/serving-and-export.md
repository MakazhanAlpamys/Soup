...
- **New Training** — create configs from templates or 154 ready-made recipes, validate, start training with live SSE log streaming and progress bar
...
- **Config Builder** — recipe dropdown (154 recipes), config schema API for dynamic form generation
